...
const Navbar = () => {
    ...
    return (
        <nav className=" backdrop-blur-2xl flex justify-end fixed top-0 right-0">
            ...
            <ul className="p-5 text-xl font-bold hover:scale-110">
            ...
            <ul className="p-5 text-xl font-bold hover:text-green-400 hover:scale-110">
            ...
            <ul className="p-5 text-xl font-bold hover:scale-110">
                <Link href="/extras" onClick={() => setHeader('Extras')}>
                    <svg className="w-12 h-10 fill-current hover:text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
