        ...
        <nav className="backdrop-blur-2xl flex justify-end fixed top-0 right-0">
            ...
            <ul className="pt-5 pr-5 pl-5 text-xl font-bold hover:scale-110">
                <Link href="/" onClick={() => setHeader('Home')}>
                    <svg className="w-10 h-10 fill-current hover:text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            <ul className="pt-5 pr-5 pl-5 font-bold hover:scale-110">
                <Link href="/skills" onClick={() => setHeader('Skills')}>
                    <svg className="w-10 h-10 fill-current hover:text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <ul className="pt-5 pr-5 pl-5 font-bold hover:text-green-400 hover:scale-110">
            ...
            <ul className="pt-5 pr-5 pl-5 font-bold hover:scale-110">
                <Link href="/extras" onClick={() => setHeader('Extras')}>
                    <svg className="w-12 h-11 fill-current hover:text-green-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100" height="100">
