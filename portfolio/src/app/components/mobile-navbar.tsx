...
const MobileNavbar = () => {
    ...
    return (
        <div className="fixed sm:hidden text-4xl font-semibold flex flex-col-2 z-50 ">
            <div className="fixed sm:hidden text-4xl font-semibold flex flex-col-2 m-4">
                {/* menu icon */}
                <button onClick={toggleMenu} className={`${isOpen ? 'hidden' : 'block'}`}>
